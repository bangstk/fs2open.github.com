...
const auto OnWarpOutHook = scripting::OverridableHook::Factory(
	"On Warp Out", "Called when a ship warps out", {{"Self", "object", "The object that is warping out."}});

const auto OnWarpInHook = scripting::OverridableHook::Factory(
	"On Warp In", "Called when a ship warps in", {{"Self", "object", "The object that is warping in."}});
